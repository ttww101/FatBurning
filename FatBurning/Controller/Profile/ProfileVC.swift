...
class ProfileVC: LWBaseVC, UIScrollViewDelegate {
    ...
    @IBOutlet weak var PrVuserNameLabel: UILabel!
    @IBOutlet weak var scrollView: UIScrollView!
    @IBOutlet weak var PrVindicatorView: UIView!
    @IBOutlet weak var PrVindicatorLeadingConstraint: NSLayoutConstraint!
    @IBOutlet weak var PrVstatusContainerView: UIView!
    @IBOutlet weak var PrVweightContainerView: UIView!

    @IBOutlet var PrVorderBtns: [UIButton]!

    var PrVcontainerViews: [UIView] {

        return [PrVstatusContainerView, PrVweightContainerView]
...
//            }
    ...
    private func getUserName() {
        ...
        LeanCloudService.shared.getUserName { (name, error) in
            if name != "" {
                self.PrVuserNameLabel.text = name
            } else {
...
//                self.PrVuserNameLabel.text = parsedName
//            } else {
//                print("Document does not exist: \(String(describing: error))")
//            }
//        }
    ...
    private func moveIndicatorView(toPage: Int) {
        ...
        PrVindicatorLeadingConstraint.constant = CGFloat(toPage) * screenWidth / 2
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        PrVindicatorLeadingConstraint.constant = scrollView.contentOffset.x / 2
        ...
        PrVorderBtns[number].isSelected = true
