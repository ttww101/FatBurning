...
//        }
    ...
    private func sortByTitle() {
        ...
        self.train0Sum = getWorkoutSumBy(title: TrainItem.train0.title)
        
        self.train1Sum = getWorkoutSumBy(title: TrainItem.train1.title)
        
        self.train2Sum = getWorkoutSumBy(title: TrainItem.train2.title)
        
        self.train3Sum = getWorkoutSumBy(title: TrainItem.train3.title)
        
        self.train4Sum = getWorkoutSumBy(title: TrainItem.train4.title)
        
        self.train5Sum = getWorkoutSumBy(title: TrainItem.train5.title)
        
        self.stretch0Sum = getWorkoutSumBy(title: StretchItem.stretch0.title)
        
        self.stretch1Sum = getWorkoutSumBy(title: StretchItem.stretch1.title)
        
        self.stretch2Sum = getWorkoutSumBy(title: StretchItem.stretch2.title)
        
        self.stretch3Sum = getWorkoutSumBy(title: StretchItem.stretch3.title)
    }
